...
<ParamField body="amount" type="integer" required>
  The amount to charge in whole currency units (euros). The API multiplies this by 100 internally to convert to cents.
  
  Example: `10` for €10.00 (becomes 1000 cents internally)
</ParamField>
